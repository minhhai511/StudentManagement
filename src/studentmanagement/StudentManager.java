...
public class StudentManager {
    ...
    public static void createStudent(int count, ArrayList<Student> ls) {
        ...
        while (true) {
            ...
            if (!CheckInput.checkIdExist(ls, id, name)) {
            ...
            String course = CheckInput.checkInputCourse();
            //check student exist or not
            if (CheckInput.checkStudentExist(ls, id, name, semester, course)) {
    ...
    public static Student getStudentByListFound(ArrayList<Student> listStudentFindByName) {
        ...
        int choice = CheckInput.checkInputIntLimit(1, listStudentFindByName.size());
    ...
    public static void report(ArrayList<Student> ls) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (Student student1 : ls) {
                ...
                if (CheckInput.checkReportExist(lr, student1.getStudentName(),
